...
You can also see [Cython](https://github.com/starlangsoftware/Corpus-Cy), [Python](https://github.com/starlangsoftware/Corpus-Py), [Java](https://github.com/starlangsoftware/Corpus), [C++](https://github.com/starlangsoftware/Corpus-CPP), [C](https://github.com/starlangsoftware/Corpus-C), [Swift](https://github.com/starlangsoftware/Corpus-Swift), [Js](https://github.com/starlangsoftware/Corpus-Js), or [C#](https://github.com/starlangsoftware/Corpus-CS) repository.
...
A directory called Corpus will be created. Or you can use below link for exploring the code:
	...
	git clone https://github.com/starlangsoftware/Corpus-Php.git
